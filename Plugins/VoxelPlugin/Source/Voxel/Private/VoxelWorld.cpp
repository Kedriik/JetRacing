...
void AVoxelWorld::ReloadPlanetTopography()
{
	VOXEL_FUNCTION_COUNTER();
	this->Generator.GetGenerator()->ReloadPlanetTopography();
}
TVoxelSharedRef<FVoxelData> AVoxelWorld::CreateData() const
{
	VOXEL_FUNCTION_COUNTER();
	this->Generator.GetGenerator()->SetPlanetRadius(this->Radius);
	this->Generator.GetGenerator()->SetPlanetTopography();
	this->Generator.GetGenerator()->SetHeightMultiplier(HeightMultiplier);
	this->Generator.GetGenerator()->SetEpsilon(this->Epsilon);
	this->Generator.GetGenerator()->SetEpsilons(this->Epsilons);
	this->Generator.GetGenerator()->SetSmoothingMethod(this->SmoothMethod);
	this->Generator.GetGenerator()->SetSmoothSize(this->SmoothSize);
