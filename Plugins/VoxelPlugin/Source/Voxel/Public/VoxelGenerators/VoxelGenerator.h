...
public:
	...
	virtual void SetPlanetRadius(float _Radius) {

	};
	virtual void SetPlanetTopography() {

	}
	virtual void SetHeightMultiplier(float multiplier) {

	}
	virtual void SetEpsilon(float epsilon) {

	}
	virtual void SetEpsilons(TArray<float> epsilons) {

	}
	virtual void SetSmoothingMethod(float method) {

	}
	virtual void SetSmoothSize(int size) {

	}

	virtual void ReloadPlanetTopography() {
